...
#define CCMPH_2_PN(ch) ((ch)&0x000000000000ffff) | (((ch)&0xffffffff00000000) >> 16)
...
#ifdef CONFIG_IEEE80211W
u32 rtw_BIP_verify(_adapter *padapter, u8 *whdr_pos, sint flen, const u8 *key, u16 id, u64 *ipn);
#endif
#ifdef CONFIG_TDLS
